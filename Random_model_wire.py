...
def test_core(n, k, failure_s):
    ...
    failure_l = 15   # The number of faulty wires increasing each time
    APL = []
    ABT = []
    RFR = []
...
def pool_core(n, k, failure_s, processes_num):
    ...
    # record all data
    s1 = "BC({0},{1},{2})_Random.xls".format(n, k, failure_s)
...
if __name__ == '__main__':
    ...
    time_end = time.time()
    print('BCube(8,2)_random:', time_end - time_start)